function[]=MyNetMatYeo_YTright(MAT,doSort,makeShort,varargin)
%% Show Y labels on the right side of the matrix
...
ty= text((nX + 2)*ones(1,length(tickpos)),tickpos,networks);
set(ty,'HorizontalAlignment','left','VerticalAlignment','middle', 'Rotation', -30)
